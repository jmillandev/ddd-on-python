...
@dataclass
class TransferMovementFactory(AggregateRootFactory[TransferMovement]):
...
@dataclass
class TransferMovementAddedFactory(EventDomainFactory[TransferMovementAdded]):
