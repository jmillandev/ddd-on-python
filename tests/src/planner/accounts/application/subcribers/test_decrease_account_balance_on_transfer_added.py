...
class TestDecreaseAccountBalanceOnTransferAdded:
    def setup_method(self):
        ...
        self.subscriber = DecreaseAccountBalanceOnTransferAdded(use_case)

    async def test_should_decreaser_balance_account_on_expense_added(self) -> None:
        account_factory = AccountFactory(id=self.event.origin_id)
