...
from src.planner.accounts.domain.exceptions.name_already_registered import NameAlreadyRegistered
...
class AccountCreator:
    ...
    async def __call__(self, id: AccountId, user_id: UserId, name: AccountName, currency: AccountCurrency, balance: AccountBalance) -> None:
        if await self._repository.search_by_name_and_user_id(name, user_id): # TODO: Implement Criteria
